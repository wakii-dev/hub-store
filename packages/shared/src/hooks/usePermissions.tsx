...
/** §2: Coordinator → D1+D2+Print; WarehouseOps → D2+Print (KHÔNG D1); Manager → all (+Dashboard). */
export const PERMISSION_MATRIX = {
  Coordinator: ['orders.view', 'fulfillment.view', 'fulfillment.print'],
  WarehouseOps: ['fulfillment.view', 'fulfillment.print'],
  Manager: ['orders.view', 'fulfillment.view', 'fulfillment.print', 'dashboard.view', 'users.manage'],
