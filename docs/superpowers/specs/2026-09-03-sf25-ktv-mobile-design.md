...
| `api/seed/tech-sample.json` | +SO-0006 (KTV-001, CONFIRMED, `TODAY@10:00`) cho e2e accept; +SO-0007 (CTV-001, CONFIRMED, `TODAY@11:00`); expectedTime hiện có → `TODAY@HH:MM` placeholder; +1 delivery order driver_name = "Nguyễn Văn An" (KTV-001) `TODAY` |
