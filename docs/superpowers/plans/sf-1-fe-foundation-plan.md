...
- [x] Task 12 — Verify + review + merge: browser 3 tầng; verifier từng dòng ACCEPTANCE; code-reviewer APPROVED; merge no-ff vào story branch; audit comment FI-234.
